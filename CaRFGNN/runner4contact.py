...
#         in_batch, label_batch = batch
#         in_batch = in_batch.to(self.device)
#         label_batch = label_batch.to(self.device)
#         targets = label_batch.edge_label

#         self.optimizer.zero_grad()
#         preds = self.nn_model.edge_pred(in_batch, label_batch)
...
# def set_config(args):
#     config_path = 'CaRFGNN/config/contact.json'
...
#     config = Config()
#     config.config_key = \
#         f"contact.T{args.tree_height}.{args.readout}"
...
#         description='Evaluating the performance of CaRFGNN.')
