...
def set_config(args):
    config_path = 'RFGNNMRwR/config/ged.json'
    ...
    config.nn_model_name = f"RFGNNMRwR.{config_dict['nn_model_name']}"
...
def main():
    parser = argparse.ArgumentParser(
        description='Evaluating the performance of RFGNNMRwR on GED datasets.')
