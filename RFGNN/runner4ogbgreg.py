...
def set_config(args):
    config_path = 'RFGNN/config/ogbgreg.json'
...
def main():
    parser = argparse.ArgumentParser(
        description='Evaluating the performance of RFGNN on OGBG datasets.')
    parser.add_argument('--dataset_name', type=str, default='ogbg-mollipo')
