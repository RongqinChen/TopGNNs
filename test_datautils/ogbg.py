...
ogbg_datamodule = OGBG_DataModule(
    'ogbg-molbbbp', 128, 0, 'to_TPF', {'height': 4},
    train_shuffle=False)

# For testing, train_loader shuffle should be setted as False
train_dataset = ogbg_datamodule.train_dataset
train_loader = ogbg_datamodule.train_loader
...
valid_dataset = ogbg_datamodule.valid_dataset
valid_loader = ogbg_datamodule.valid_loader
...
test_dataset = ogbg_datamodule.test_dataset
test_loader = ogbg_datamodule.test_loader
